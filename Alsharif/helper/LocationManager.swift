...
final class LocationManager: NSObject {
    ...
    func getAddressFromLatLon(pdblLatitude: String, withLongitude pdblLongitude: String,callback: @escaping ( _ status: Bool,_ mapaddress:String?,_ mapcountry:String?) ->Void) {
