...
//  Namla
//
//  Created by Ali Shaheen on 17/03/2021.
//
...
final  class MainTF: UITextField {
    ...
    func setEyeView(){
        ...
        if isPasswordTF {
            ...
            let imageView = UIImageView(frame: CGRect(x:  self.semanticContentAttribute == .forceRightToLeft ? 10:0, y: 0, width: 20, height: 20))
        ...
        padding = UIEdgeInsets(top: 0, left:  self.semanticContentAttribute == .forceRightToLeft ? textPadding+leftPadding + 5 : textPadding+leftPadding , bottom: 0, right: rightPadding )
